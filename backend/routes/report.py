...
async def get_report_crm_data(
    ...
    for m in range(1, 13):
        ...
        for record in month_records:
            ...
            elif staff_first_date and staff_first_date.startswith(month_str) and staff_first_date == record['record_date']:
    ...
    staff_daily_data = {}
    # Track unique customers for NDP and RDP per staff-product-date combination
