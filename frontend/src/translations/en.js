...
const en = {
  ...
  izin: {
    ...
    // Admin Monitor Keys
    monitorTitle: 'Monitor Izin',
    monitorSubtitle: 'Track staff break times and manage daily limits',
    dailyHistory: 'Daily History',
    staffWithIzin: 'Staff with Izin',
    currentlyOnBreak: 'Currently on Break',
    todayHistory: 'Today\'s History',
    dailyLimit: 'Daily Limit',
    timesIzin: 'times izin',
    ongoing: 'Ongoing',
    noIzinToday: 'No izin records today',
    filter: 'Filter',
    allStaff: 'All Staff',
    fromDate: 'From Date',
    toDate: 'To Date',
    ...
    changeFilterHint: 'Try adjusting the date range or staff filter',
  },
