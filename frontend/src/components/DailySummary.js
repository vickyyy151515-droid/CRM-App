...
export default function DailySummary({ isAdmin = false }) {
  ...
  const getRankBadge = (rank, total) => {
    ...
    return (
      <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-sm font-medium bg-slate-100 text-slate-600">
        #{rank} of {total}
      </span>
    );
  };
  ...
  return (
    <div>
      ...
      {loading ? (
        <div className="text-center py-12 text-slate-600">Loading summary...</div>
      ) : !summary ? (
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-bold text-slate-900">{formatCurrency(summary.total_omset)}</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-bold text-slate-900">{summary.total_ndp || 0}</p>
            </div>
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 border border-violet-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-bold text-slate-900">{summary.total_rdp || 0}</p>
            </div>
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-bold text-slate-900">{summary.total_forms || 0}</p>
            </div>
          </div>
          ...
          {summary.top_performer && (
            <div className="bg-gradient-to-r from-yellow-50 via-amber-50 to-orange-50 border border-yellow-200 rounded-xl p-5 mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-semibold text-slate-900">Top Performer of the Day</h3>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-2xl font-bold text-slate-900">{summary.top_performer.staff_name}</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-bold text-slate-900">{formatCurrency(summary.my_stats?.total_omset)}</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5">
              <div className="flex items-center gap-2 mb-2">
                <UserPlus className="text-blue-600" size={20} />
              ...
              <p className="text-2xl font-bold text-slate-900">{summary.my_stats?.ndp_count || 0}</p>
            </div>
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 border border-violet-200 rounded-xl p-5">
              <div className="flex items-center gap-2 mb-2">
                <RefreshCcw className="text-violet-600" size={20} />
              ...
              <p className="text-2xl font-bold text-slate-900">{summary.my_stats?.rdp_count || 0}</p>
            </div>
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-5">
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-2xl font-bold text-slate-900">{summary.my_stats?.form_count || 0}</p>
            </div>
          </div>

          {/* Team Comparison */}
          <div className="bg-white border border-slate-200 rounded-xl p-5 mb-6">
            <h3 className="font-semibold text-slate-900 mb-4">Team Comparison</h3>
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-sm text-slate-500 mb-1">Team Total OMSET</p>
                <p className="text-lg font-bold text-slate-900">{formatCurrency(summary.team_total_omset)}</p>
              </div>
              <div>
                <p className="text-sm text-slate-500 mb-1">Team NDP</p>
                <p className="text-lg font-bold text-slate-900">{summary.team_total_ndp || 0}</p>
              </div>
              <div>
                <p className="text-sm text-slate-500 mb-1">Team RDP</p>
                <p className="text-lg font-bold text-slate-900">{summary.team_total_rdp || 0}</p>
              </div>
            </div>
          </div>
          ...
          {summary.top_performer && summary.top_performer.staff_id !== summary.my_stats?.staff_id && (
            <div className="bg-gradient-to-r from-yellow-50 via-amber-50 to-orange-50 border border-yellow-200 rounded-xl p-5 mb-6">
              ...
              <p className="text-xl font-bold text-slate-900">{summary.top_performer.staff_name}</p>
