...
export default function AdminDBBonanza() {
  ...
  return (
    <div data-testid="admin-db-bonanza">
      ...
      {showSettingsPanel && (
        <SettingsPanel
          title="DB Bonanza Settings"
          settings={bonanzaSettings}
          onSettingsChange={setBonanzaSettings}
          onSave={handleSaveSettings}
          onClose={() => setShowSettingsPanel(false)}
          saving={savingSettings}
          testIdPrefix="bonanza-settings"
        />
      )}
      ...
      {/* Tabs - Using Shared Component */}
      <ModuleTabs
        activeTab={activeTab}
        setActiveTab={setActiveTab}
        archivedCount={archivedRecords?.total || 0}
        testIdPrefix="bonanza"
      />
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      ...
                      {database.excluded_count > 0 && (
                        <span className="text-violet-600 font-medium ml-1">{database.excluded_count}</span>
                      )}
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-4 mb-4">
                    ...
                    >
                      ...
                      <option value="invalid_archived">Archived</option>
                    </select>
                  </div>
