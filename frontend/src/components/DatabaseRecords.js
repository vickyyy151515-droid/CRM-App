                ...
                {records.map((record) => (
                  ...
                  >
                    ...
                    {columns.map((col, idx) => {
                      ...
                      const isWhatsAppLink = col.toLowerCase() === 'telpon' || (cellValue && cellValue.includes('wa.me'));
                      
                      if (isWhatsAppLink && cellValue) {
                        const whatsappUrl = cellValue.startsWith('http') ? cellValue : `https://${cellValue}`;
                        return (
