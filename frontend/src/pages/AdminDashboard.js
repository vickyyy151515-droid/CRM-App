...
const DownloadRequests = lazy(() => import('../components/DownloadRequests'));
...
const AllAssignments = lazy(() => import('../components/AllAssignments'));
const StaffProgress = lazy(() => import('../components/StaffProgress'));
const AdminReservedMembers = lazy(() => import('../components/AdminReservedMembers'));
const AdminOmsetCRM = lazy(() => import('../components/AdminOmsetCRM'));
const AdminDBBonanza = lazy(() => import('../components/AdminDBBonanza'));
const AdminMemberWDCRM = lazy(() => import('../components/AdminMemberWDCRM'));
const AdvancedAnalytics = lazy(() => import('../components/AdvancedAnalytics'));
const ExportCenter = lazy(() => import('../components/ExportCenter'));
const ReportCRM = lazy(() => import('../components/ReportCRM'));
const BonusCalculation = lazy(() => import('../components/BonusCalculation'));
const AdminLeaveRequests = lazy(() => import('../components/AdminLeaveRequests'));
const LeaveCalendar = lazy(() => import('../components/LeaveCalendar'));
const AdminIzinMonitor = lazy(() => import('../components/AdminIzinMonitor'));
...
const OfficeInventory = lazy(() => import('../components/OfficeInventory'));
const AttendanceAdmin = lazy(() => import('./AttendanceAdmin'));
const DataCleanup = lazy(() => import('./DataCleanup'));
...
export default function AdminDashboard({ user, onLogout }) {
  ...
  const allMenuItems = useMemo(() => [
    ...
    { id: 'leave', label: t('nav.leaveRequests'), icon: CalendarOff, badge: stats.pendingLeave },
