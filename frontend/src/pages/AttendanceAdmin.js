 ...
 * Refactored: Fee & Payment tab moved to separate component
 */
...
import FeePaymentTab from '../components/attendance/FeePaymentTab';
  ...
  return (
    <div className="space-y-6" data-testid="attendance-admin">
      ...
      {activeTab === 'totp-setup' && (
        <TotpSetupTab 
          filteredTotpStatus={filteredTotpStatus}
          searchQuery={searchQuery}
          setSearchQuery={setSearchQuery}
          expandedStaff={expandedStaff}
          setExpandedStaff={setExpandedStaff}
          handleResetTotp={handleResetTotp}
          resettingTotp={resettingTotp}
        />
      )}

      {/* Fee & Payment Tab - Now using separate component */}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <SummaryCard 
          icon={Users} 
          label="Total Staff" 
          value={todayData.summary.total_staff}
        ...
        <SummaryCard 
          icon={CheckCircle} 
          label="Checked In" 
          value={todayData.summary.checked_in}
        ...
        <SummaryCard 
          ...
          value={todayData.summary.not_checked_in}
...
function SummaryCard({ icon: Icon, label, value, iconBg, iconColor, valueColor = 'text-slate-900 dark:text-white' }) {
  return (
...
function HistoryTab({ historyData, startDate, setStartDate, endDate, setEndDate, fetchHistory }) {
  return (
...
// TOTP Setup Tab Component
function TotpSetupTab({ 
  filteredTotpStatus, 
  searchQuery, 
  setSearchQuery, 
  expandedStaff, 
